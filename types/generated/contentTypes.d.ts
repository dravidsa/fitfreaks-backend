...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    attendee_catagories: Attribute.Component<
      'site-component.attendee-catagories',
      true
    >;
    event_catagories: Attribute.Component<
      'site-component.event-categories',
      true
    >;
...
export interface ApiEventEnrollmentEventEnrollment
  extends Schema.CollectionType {
  collectionName: 'event_enrollments';
  info: {
    singularName: 'event-enrollment';
    pluralName: 'event-enrollments';
    displayName: 'event_enrollment';
    description: '';
  };
  options: {
    draftAndPublish: true;
